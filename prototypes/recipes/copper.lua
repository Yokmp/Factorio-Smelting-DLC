...
-- T1 2:2; T2 2:3; T3 2:4
    ...
    ------------------------
    {
      ...
      icon = "__Smelting-DLC__/graphics/icons/copper-casting.png",
      icon_size = 32,
      normal = {
        enabled = false,
        energy_required = 1,
    ...
    -----------------------
    {
      ...
      category = "crafting",
      icon = "__Smelting-DLC__/graphics/icons/copper-ingot-plate.png",
      icon_size = 32,
      normal = {
        energy_required = 1.5,
        enabled = false,
    ...
    ----------------------
    {
      ...
      category = "crafting",
			subgroup = "raw-material",
      icon = "__Smelting-DLC__/graphics/icons/copper-ingot-roll.png",
      icon_size = 32,
      normal = {
        energy_required = 1,
        enabled = false,
    ...
    ----------------------
    {
      ...
      category = "crafting",
      icon = "__Smelting-DLC__/graphics/icons/copper-roll-plate.png",
      icon_size = 32,
      normal = {
        energy_required = 0.5,
        enabled = false,
