data:extend({
  ...
  -------------------------------
  {
    ...
    crafting_categories = {"basic_smelting_liquid_y"},
  ...
  ------------------------------
  {
    ...
    crafting_categories = {"basic_smelting_liquid_y", "advanced_smelting_liquid_y"},
    fast_replaceable_group = "furnace",
    crafting_speed = 1.75,
    source_inventory_size = 1,
    result_inventory_size = 1,
  ...
  ------------------------
  {
    ...
    allowed_effects = {"consumption", "speed", "productivity", "pollution"},
    crafting_categories = {"basic_casting_liquid_y"},
  ...
  target_temperature = 500,
	fluid_boxes = {
		{ -- back top METAL
			...
			minimum_temperature = 1500.0, -- min iron
...
------------------------
{
  ...
  module_specification = { module_slots = 3 },
  allowed_effects = {"consumption", "speed", "productivity", "pollution"},
  crafting_categories = {"basic_casting_liquid_y", "advanced_casting_liquid_y"},
  fast_replaceable_group = "assembling-machine",
  animation = make_4way_animation_from_spritesheet({
    layers = {
	    {
